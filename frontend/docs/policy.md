...
3. **유료 서비스 제공 및 결제 관리**
    - 구독 및 인앱 결제 상태의 확인·관리, 구매내역 관리, 환불 대응
4. **광고 보상 제공**
...
| 저장 | 구독·인앱 결제 내역(상품 식별자, 거래 식별자, 구매·만료 일시 등) | 결제 상태 관리를 위해 저장. **신용카드 번호 등 결제수단 정보는 Apple이 처리하며 운영자는 수집하지 않음** |
...
| RevenueCat, Inc. | 구독·인앱 결제 상태 관리 | 미국 |
...
| RevenueCat | 미국 | 회원 식별자, 구독·결제 상태 정보 | 결제·구독 이용 시점에 네트워크를 통한 전송 | 구독·인앱 결제 상태 관리 | 회원 탈퇴 시까지 |
...
2. 개정된 본 방침은 2026년 7월 10일부터 시행됩니다.
...
7. **구독**: 월간 또는 연간 단위로 자동 갱신되는 유료 이용권을 의미합니다.
...
3. 대화 기능에는 이용 등급에 따른 일일 이용 한도가 적용될 수 있으며, 한도는 매일 정해진 시각에 초기화됩니다. 구체적인 한도와 등급별 혜택은 앱 내에 표시됩니다.
...
1. 운영자는 구독 및 건초 팩 등 유료 서비스를 제공하며, 상품의 종류·가격·제공 내용은 앱 내 및 App Store 상품 정보에 표시됩니다.
2. 유료 서비스의 결제는 Apple App Store의 인앱 결제를 통해 이루어지며, 결제 조건 및 절차는 Apple의 정책을 따릅니다.
3. **구독의 자동 갱신**: 구독은 월간 또는 연간 단위로 제공되며, 이용자가 현재 구독 기간 종료 최소 24시간 전에 해지하지 않으면 자동으로 갱신되고 이용자의 App Store 계정으로 요금이 청구됩니다.
4. **구독의 해지**: 이용자는 언제든지 기기의 설정 > [Apple 계정] > 구독 메뉴에서 자동 갱신을 해지할 수 있습니다. 해지하더라도 이미 결제된 구독 기간이 만료될 때까지는 구독 혜택이 유지됩니다.
5. **구독 혜택**: 구독 회원에게는 대화 한도 확장, 개인 일기 발행, 배너 광고 제거, 구독 전용 꾸미기 콘텐츠, 건초 증정(플랜별 최초 1회) 등의 혜택이 제공됩니다. 구독이 만료·해지·환불되는 경우 구독 전용 혜택의 이용은 중단됩니다.
6. **환불**: 인앱 결제의 환불(청약철회)은 Apple App Store의 환불 정책 및 관계 법령에 따라 처리되며, 이용자는 Apple의 환불 신청 절차(reportaproblem.apple.com)를 통해 신청할 수 있습니다. 운영자는 Apple을 통하지 않은 별도의 현금 환불을 제공하지 않습니다.
7. **환불 시 재화 회수**: 구독 또는 건초 팩 결제가 환불되는 경우, 해당 결제로 지급된 건초는 잔여 보유량의 범위 내에서 회수될 수 있으며, 구독 전용 콘텐츠의 이용 자격은 즉시 종료됩니다.
...
4. 회원 탈퇴 시 잔여 건초 및 보유 아이템은 모두 소멸되며 복구·환급되지 않습니다. 탈퇴 전 유료 결제 건에 대한 환불은 제7조 제6항의 절차를 따릅니다.
...
3. **회원 탈퇴만으로는 App Store 구독이 해지되지 않습니다.** 구독 중인 회원은 탈퇴와 별도로 기기의 설정 > [Apple 계정] > 구독에서 구독을 해지해야 하며, 해지하지 않을 경우 요금이 계속 청구될 수 있습니다.
4. 회원이 다음 각 호의 사유에 해당하는 경우, 운영자는 회원자격을 제한 및 정지시킬 수 있습니다.
...
1. 운영자는 서비스 내에 광고(리워드 광고, 배너 광고 등)를 게재할 수 있습니다.
...
2. 개정된 본 약관은 2026년 7월 10일부터 시행됩니다.
